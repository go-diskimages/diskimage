...
require (
	...
	github.com/go-fde/apfs v0.0.0-20260910174216-e05a1ddab67f
	github.com/go-fde/fde v0.0.0-20260905061352-ed10e8d10a62
...
require (
	github.com/go-bootloaders/grub v0.0.0-20260901144556-3dc1d768215d
